...
export function PhoneFrame({ children }: { children: ReactNode }) {
  return (
    <div className="min-h-full w-full bg-black/40 flex items-center justify-center sm:py-6">
      <div id="phone-root" className="relative w-full sm:w-[390px] h-[100dvh] sm:h-[844px] sm:rounded-[44px] sm:border sm:border-line sm:shadow-2xl overflow-hidden bg-bg">
        {/* notch */}
